...
target.compileFonts = function () {
    var fontsDir = 'cartridges/plugin_reorder_demo/cartridge/static/default/fonts';
    mkdir('-p', fontsDir);
    cp('-r', 'node_modules/font-awesome/fonts/', 'cartridges/plugin_reorder_demo/cartridge/static/default');
...
target.release = function (args) {
    ...
    if (['patch', 'minor', 'major'].indexOf(type) >= 0) {
        ...
        var propertiesFileName = path.resolve('./cartridges/plugin_reorder_demo/cartridge/templates/resources/version.properties')
